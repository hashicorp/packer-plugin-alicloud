...
- `security_enhancement_strategy` (string) - Specifies whether to enable security
  hardening. Active: enables security hardening. This value is applicable only to
  public images. Deactive: does not enable security hardening. This value is
  applicable to all image types.

- `image_family` (string) - The name of the image family. You can set this parameter
  to choose the latest available custom image from the specified image family to
  create the instance.
